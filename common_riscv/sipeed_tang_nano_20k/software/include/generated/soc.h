...
#define CONFIG_CLOCK_FREQUENCY 54000000
...
#define CONFIG_IDENTIFIER "LiteX SoC on Tang Nano 20K 2026-01-14 16:02:03"
...
#define FLASH_BOOT_ADDRESS 8388608
...
#define CONFIG_CPU_INTERRUPTS 9
#define BUTTONS_INTERRUPT 3
#define ISO7816_INTERRUPT 8
...
static inline const char * config_identifier_read(void) {
	return "LiteX SoC on Tang Nano 20K 2026-01-14 16:02:03";
}
...
static inline int iso7816_interrupt_read(void) {
	return 8;
}
