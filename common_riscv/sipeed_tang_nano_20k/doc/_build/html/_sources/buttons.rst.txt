...
| Register                                       | Address                                |
+================================================+========================================+
| :ref:`BUTTONS_IN <BUTTONS_IN>`                 | :ref:`0xf0001800 <BUTTONS_IN>`         |
+------------------------------------------------+----------------------------------------+
| :ref:`BUTTONS_MODE <BUTTONS_MODE>`             | :ref:`0xf0001804 <BUTTONS_MODE>`       |
+------------------------------------------------+----------------------------------------+
| :ref:`BUTTONS_EDGE <BUTTONS_EDGE>`             | :ref:`0xf0001808 <BUTTONS_EDGE>`       |
+------------------------------------------------+----------------------------------------+
| :ref:`BUTTONS_EV_STATUS <BUTTONS_EV_STATUS>`   | :ref:`0xf000180c <BUTTONS_EV_STATUS>`  |
+------------------------------------------------+----------------------------------------+
| :ref:`BUTTONS_EV_PENDING <BUTTONS_EV_PENDING>` | :ref:`0xf0001810 <BUTTONS_EV_PENDING>` |
+------------------------------------------------+----------------------------------------+
| :ref:`BUTTONS_EV_ENABLE <BUTTONS_EV_ENABLE>`   | :ref:`0xf0001814 <BUTTONS_EV_ENABLE>`  |
+------------------------------------------------+----------------------------------------+
...
+-------+------+---------------------------------------------------------------------------+
| [1]   | I1   | `1` if a `i1` event occurred. This Event is triggered on **rising** edge. |
+-------+------+---------------------------------------------------------------------------+
