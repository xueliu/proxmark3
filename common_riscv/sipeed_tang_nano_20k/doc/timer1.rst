...
| Register                                         | Address                                 |
+==================================================+=========================================+
| :ref:`TIMER1_LOAD <TIMER1_LOAD>`                 | :ref:`0xf0005000 <TIMER1_LOAD>`         |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER1_RELOAD <TIMER1_RELOAD>`             | :ref:`0xf0005004 <TIMER1_RELOAD>`       |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER1_EN <TIMER1_EN>`                     | :ref:`0xf0005008 <TIMER1_EN>`           |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER1_UPDATE_VALUE <TIMER1_UPDATE_VALUE>` | :ref:`0xf000500c <TIMER1_UPDATE_VALUE>` |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER1_VALUE <TIMER1_VALUE>`               | :ref:`0xf0005010 <TIMER1_VALUE>`        |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER1_EV_STATUS <TIMER1_EV_STATUS>`       | :ref:`0xf0005014 <TIMER1_EV_STATUS>`    |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER1_EV_PENDING <TIMER1_EV_PENDING>`     | :ref:`0xf0005018 <TIMER1_EV_PENDING>`   |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER1_EV_ENABLE <TIMER1_EV_ENABLE>`       | :ref:`0xf000501c <TIMER1_EV_ENABLE>`    |
+--------------------------------------------------+-----------------------------------------+
